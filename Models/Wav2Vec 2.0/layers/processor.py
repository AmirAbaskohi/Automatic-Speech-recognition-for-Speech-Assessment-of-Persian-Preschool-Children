...
class Wav2Vec2Processor:
    ...
    def _setup_vocab(self):
        if not os.path.isfile(self.vocab_path):
            url = "https://github.com/https://github.com/AmirAbaskohi/Automatic-Speech-recognition-for-Speech-Assessment-of-Preschool-Children/blob/main/Vocab%20files/vocab.json"
