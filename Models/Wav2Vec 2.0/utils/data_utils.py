...
# Put your tf records path here
PATH_TO_TF_RECORDS_LIBRISPEECH = ""

# Put Librispeech test data path here
DATA_PATH_LIBRISPEECH = ""

# Put TIMIT train data path here
DATA_PATH_TIMIT = ""
...
class LibriSpeechDataLoaderArgs:
    ...
    tfrecords: List[str] = field(
        default_factory=lambda: [PATH_TO_TF_RECORDS_LIBRISPEECH]
    )
    data_dir: str = DATA_PATH_LIBRISPEECH
...
class CommonVoiceDataLoader(CommonDataLoader):
    def __init__(self, args: CommonVoiceLoaderArgs):
        super().__init__(
            args.batch_size,
            args.buffer_size,
            args.audio_pad_id,
