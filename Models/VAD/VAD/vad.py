...
class VoiceActivityDetector():
    ...
    def __init__(self, wave_input_filename):
        ...
        self.speech_window = 0.9  # half a second
        self.speech_energy_threshold = 0.78  # 60% of energy in voice band
    ...
    def convert_windows_to_readible_labels(self, detected_windows):
        ...
        for window in detected_windows:
            if (window[1] == 1.0 and is_speech == 0):
                ...
                speech_index_label['speech_begin_index'] = window[0]
            ...
            if (window[1] == 0.0 and is_speech == 1):
                ...
                speech_index_label['speech_end_index'] = window[0]
                speech_time.append(speech_label)
                speech_index.append(speech_index_label)

                print(window[0], speech_time_end)
        return speech_time, speech_index
